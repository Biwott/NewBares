...
<head>
    ...
    <meta name="keywords"
        content="forex, affiliate marketing, work online, watch videos, earn watching, invest, bitcoin, cryptocurrency, etherium, free spin">
    <meta name="description"
        content="Earnest Ventures is a trusted investment broker keen at ensuring investors get their return on investment">
    <meta name="robots" content="noindex,nofollow">
    <title>Admin Portal- Earnest Ventures</title>
...
<body>
    ...
    <script src="{{asset('dist/js/admin.init.mini-sidebar.js')}}"></script>
