                                ...
                                <div class="col-sm-12">
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap dataTable"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{showDateTime($withdrawal->created_at)}}
                                                </td>
                                                <td>{{ $withdrawal->code }}</td>
                                                <td style="text-transform: lowercase">

                                                    <a href="{{'/admin/users/detail/'.$withdrawal->user_id}}">
                                                        <u>
                                                            {{ $withdrawal->user()->pluck('username')->first() }}
                                                        </u>
                                                    </a>
                                                </td>
                                                <td style="text-transform: lowercase">
                                                    {{ $withdrawal->user()->pluck('phone')->first() }}
                                                </td>
                                                <td>{{convertCurrency(\App\Models\User::find($withdrawal->user_id), $withdrawal->final_amount) }}
                                                </td>
                                                <td>
                                                    ...
                                                    md-trigger btn-sm feather icon-check-square f-12"
                                                        ...
                                                        data-amount="{{ convertCurrency(\App\Models\User::find($withdrawal->user_id), $withdrawal->final_amount) }}"
                                                        data-username="{{ $withdrawal->user()->pluck('username')->first() }}">
                                                        Approve
                                                    </button>
                                                    ...
                                                    <div id="modal-approve" class="modal fade" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form wire:submit.prevent="approve({{$withdrawal}})">
                                                    ...
                                                    <div id="modal-decline" class="modal fade" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form wire:submit.prevent="decline({{$withdrawal}})">
                                                                    <input type="hidden" name="id">
                                                                    <div class="modal-body">
                                                                        <h6>Do you want to <span
